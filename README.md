...
SURABAYA KOI SHOW
2 - 4 OKTOBER 2026
TIM PEMBERANGKATAN JUMAT, 2 OKTOBER 2026 , JAM 08.00 | MOBIL ROMADHON
1. ROMADHON
2. FAHRONY
3. ANDRE
4. AQIL
...
Barang yang dibawa: 
1. Kaos (15pcs) 
2. Gantungan Kunci (50)
3. Stand Booth
4. Goodie Bag (10 pcs)
5. Bendera
6. Roll Banner 
7. Mug
8. Hadiah GC (TANYA MAS TOPO)
...
BANDUNG KOI SHOW - IRFAN HAKIM
10 - 14 September 2026
TIM PEMBERANGKATAN KAMIS 10 SEPTEMBER, JAM 15.00 | MOBIL ROMADHON
1. ERFAN
2. RONY

Barang yang dibawa: 
1. Kaos (10pcs) 
2. Gantungan Kunci (30)
3. Stand Booth
4. Goodie Bag (10 pcs)
5. Bendera
6. Roll Banner 
...
ANALISA UPDATE BY DATA MASTER KOI
1. TUTORIAL DIAWAL APLIKASI
...
VIDEO
POIN 1
1.⁠ ⁠TEMA ADS ADANYA KESAMAAN
2.⁠ ⁠⁠GANTI TALENT
3.⁠ ⁠⁠GANTI KEY FRAME
4.⁠ ⁠⁠SCRIPT KESELLER/BIDDER/HOBBYST
5.⁠ ⁠VOICE OFFER
...
MENU BIDDER IKAN SAYA   -> FILTER SELLER (Current)
                        ...
                        -> BULAN/SEMUA BULAN
HISTORI BID             -> HIDDEN
SLIDER ADS APP IOS      -> KANAN KIRI TERPOTONG
DETAIL INFO LELANG      -> SEPERTI TOKOPEDIA
                        -> HISTORI LELANG TETAP
                        -> PEMBUATAN ICON
                        -> DETAIL IKAN, SELLER, CHAT SELLER, ALARM
MEMBER AKTIF MENU SELLER-> HIDDEN
REKENING PENJAMIN       -> MOVE KANAN ATAS (UTAMA) TUKAR DENGAN MENU POIN
MENU STORE              -> PERKEMBANGAN DASHBOARD SELLER DAN LAIN-LAIN

TEKNIS PELAKSANAAN EVENT KC/AZ/GO MASTER KOI BOT (FORM EVENT)
    -> IKAN SEJENIS TIDAK DIPERBOLEHKAN BARENG

AZUKARI
    -> SELURUH PENAGIHAN WAJIB DITAGIH OLEH TIM MASTER KOI 
    -> SELURUH PEMBAYARAN MELALUI REKPEN 
    -> MINIMAL 50% DARI OMZET AKAN DIBEKUKAN DI MASTER KOI BOT
    -> SISANYA AKAN DISERAHKAN KE SELLER PENYELENGGARA
    -> OMZET YANG DIBEKUKAN AKAN DITERUSKAN PASCA SELURUH IKAN DIKIRIM
    -> TIDAK BOLEH ADA HADIAH UANG TUNAI KECUALI DIJAMINKAN KE MASTER KOI BOT
    -> FOTO VIDEO APA ADANYA (NO EDIT)
        -> DIBUKTIKAN DENGAN KERTAS HOLOGRAM DI VIDEO
    -> APABILA ADA IKAN MATI MASTER KOI BOT HANYA MENANGGUNG SESUAI PERSENTASE OMZET YANG DIBEKUKAN
    -> PASCA EVENT MARKETING WAJIB KONFIRMASI HASIL OMZET (BOLEH DIBATALKAN)
